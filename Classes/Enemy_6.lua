...
Enemy_6 = {}
Enemy_6.__index = Enemy_6

-- Enemy_1 class attributes
function Enemy_6.new(distance, shadow, speed)
    local self = setmetatable({}, Enemy_6)
    self.x = distance
    self.y = 312
    self.width = 100
    self.height = 160
    self.animation1 = love.graphics.newImage("Characters/OrcSavageIdleSide1.png")
    self.animation2 = love.graphics.newImage("Characters/OrcSavageIdleSide2.png")
