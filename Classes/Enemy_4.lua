...
function Enemy_4.new(distance, shadow, speed)
    local self = setmetatable({}, Enemy_4)
    self.x = distance
    self.y = 312
    self.width = 100
    self.height = 160
    self.animation1 = love.graphics.newImage("Characters/GoblinWolfRiderIdleSide1.png")
    self.animation2 = love.graphics.newImage("Characters/GoblinWolfRiderIdleSide2.png")
