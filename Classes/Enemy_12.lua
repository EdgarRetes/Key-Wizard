...
Enemy_12 = {}
Enemy_12.__index = Enemy_12

-- Enemy_10 class attributes
function Enemy_12.new(distance, shadow, speed)
    local self = setmetatable({}, Enemy_12)
    self.x = distance
    self.y = 312
    self.width = 100
    self.height = 160
    self.animation1 = love.graphics.newImage("Characters/GnollGruntIdle2Side1.png")
    self.animation2 = love.graphics.newImage("Characters/GnollGruntIdle2Side2.png")
