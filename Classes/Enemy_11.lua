...
Enemy_11 = {}
Enemy_11.__index = Enemy_11

-- Enemy_10 class attributes
function Enemy_11.new(distance, shadow, speed)
    local self = setmetatable({}, Enemy_11)
    self.x = distance
    self.y = 312
    self.width = 100
    self.height = 160
    self.animation1 = love.graphics.newImage("Characters/GnollGruntIdleSide1.png")
    self.animation2 = love.graphics.newImage("Characters/GnollGruntIdleSide2.png")
