...
Enemy_8 = {}
Enemy_8.__index = Enemy_8

-- Enemy_7 class attributes
function Enemy_8.new(distance, shadow, speed)
    local self = setmetatable({}, Enemy_8)
    self.x = distance
    self.y = 312
    self.width = 100
    self.height = 160
    self.animation1 = love.graphics.newImage("Characters/LizardfolkArcherIdleSide1.png")
    self.animation2 = love.graphics.newImage("Characters/LizardfolkArcherIdleSide2.png")
