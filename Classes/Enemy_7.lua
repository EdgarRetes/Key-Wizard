...
Enemy_7 = {}
Enemy_7.__index = Enemy_7

-- Enemy_7 class attributes
function Enemy_7.new(distance, shadow, speed)
    local self = setmetatable({}, Enemy_7)
    self.x = distance
    self.y = 312
    self.width = 100
    self.height = 160
    self.animation1 = love.graphics.newImage("Characters/OrcShamanIdleSide1.png")
    self.animation2 = love.graphics.newImage("Characters/OrcShamanIdleSide2.png")
