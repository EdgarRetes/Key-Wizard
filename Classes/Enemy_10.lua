...
Enemy_10 = {}
Enemy_10.__index = Enemy_10

-- Enemy_10 class attributes
function Enemy_10.new(distance, shadow, speed)
    local self = setmetatable({}, Enemy_10)
    self.x = distance
    self.y = 312
    self.width = 100
    self.height = 160
    self.animation1 = love.graphics.newImage("Characters/LizardfolkGladiatorIdleSide1.png")
    self.animation2 = love.graphics.newImage("Characters/LizardfolkGladiatorIdleSide2.png")
