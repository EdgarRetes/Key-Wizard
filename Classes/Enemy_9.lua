...
Enemy_9 = {}
Enemy_9.__index = Enemy_9

-- Enemy_9 class attributes
function Enemy_9.new(distance, shadow, speed)
    local self = setmetatable({}, Enemy_9)
    self.x = distance
    self.y = 312
    self.width = 100
    self.height = 160
    self.animation1 = love.graphics.newImage("Characters/LizardfolkSpearmanIdleSide1.png")
    self.animation2 = love.graphics.newImage("Characters/LizardfolkSpearmanIdleSide2.png")
