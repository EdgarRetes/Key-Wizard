...
local Win9 = require "Screens/Win"
local completed
local win_sound
...
function load_level_9()
    ...
    enemies = {}
    keys = {"w", "o", "space", "o", "w", "space", "space", "o", "w", "w", "w", "w", "space", "o", "o", "o", "space", "w", "space", "w", "space", "o", "space", "o", "space", "o", "o", "w", "space", "w", "w", "o", "space", "w", "space", "o", "w", "space", "o", "o", "space", "space", "w", "o", "w", "w", "o", "w", "space", "o", "o", "space", "w", "w", "o", "w", "o", "o", "o", "w", "w", "o", "o", "o", "space", "w", "space", "o", "r", "w", "u", "o", "e", "i", "u", "r", "space", "space", "o", "r", "w", "u", "i", "e", "u", "r", "e", "w", "w", "e", "o", "r", "w", "o", "space", "o", "w", "o", "w"}
    ...
    table.insert(enemies, Enemy_8.new(1500, false, 2))
    table.insert(enemies, Enemy_8.new(1700, false, 2))
    table.insert(enemies, Enemy_8.new(1900, true, 2))

    table.insert(enemies, Enemy_8.new(2300, false, 2))
    table.insert(enemies, Enemy_8.new(2500, false, 2))
    table.insert(enemies, Enemy_8.new(2700, true, 2))

    table.insert(enemies, Enemy_8.new(3100, true, 2))
    table.insert(enemies, Enemy_8.new(3300, false, 2))
    table.insert(enemies, Enemy_8.new(3500, false, 2))

    table.insert(enemies, Enemy_8.new(3900, false, 2))
    table.insert(enemies, Enemy_8.new(4100, false, 2))
    table.insert(enemies, Enemy_8.new(4300, false, 2))
    table.insert(enemies, Enemy_8.new(4500, true, 2))

    table.insert(enemies, Enemy_8.new(4900, false, 2))
    table.insert(enemies, Enemy_8.new(5000, false, 2))
    table.insert(enemies, Enemy_8.new(5100, false, 2))
    table.insert(enemies, Enemy_8.new(5200, true, 2))

    table.insert(enemies, Enemy_8.new(5500, false, 2))
    table.insert(enemies, Enemy_8.new(5600, true, 2))
    table.insert(enemies, Enemy_8.new(5700, false, 2))
    table.insert(enemies, Enemy_8.new(5800, true, 2))

    table.insert(enemies, Enemy_8.new(6100, false, 2))
    table.insert(enemies, Enemy_8.new(6200, true, 2))
    ...
    table.insert(enemies, Enemy_8.new(10700, false, 3))
    table.insert(enemies, Enemy_8.new(10800, true, 3))
    table.insert(enemies, Enemy_8.new(10900, false, 3))
    table.insert(enemies, Enemy_8.new(11000, false, 3))
    table.insert(enemies, Enemy_8.new(11100, false, 3))
    table.insert(enemies, Enemy_8.new(11200, true, 3))

    table.insert(enemies, Enemy_8.new(11600, false, 3))
    table.insert(enemies, Enemy_8.new(11700, true, 3))
    table.insert(enemies, Enemy_8.new(11800, false, 3))
    table.insert(enemies, Enemy_8.new(11900, false, 3))
    table.insert(enemies, Enemy_8.new(12000, true, 3))
    table.insert(enemies, Enemy_8.new(12100, false, 3))
    table.insert(enemies, Enemy_8.new(12200, false, 3))

    table.insert(enemies, Enemy_8.new(12600, true, 3))
    table.insert(enemies, Enemy_8.new(12700, true, 3))
    table.insert(enemies, Enemy_8.new(12800, false, 3))
    table.insert(enemies, Enemy_8.new(12900, false, 3))
    table.insert(enemies, Enemy_8.new(13000, false, 3))
    table.insert(enemies, Enemy_8.new(13100, false, 3))
    table.insert(enemies, Enemy_8.new(13200, false, 3))
    table.insert(enemies, Enemy_8.new(13300, false, 3))
    table.insert(enemies, Enemy_8.new(13400, true, 3))
    ...
    table.insert(enemies, Enemy_8.new(14400, false, 3))
    table.insert(enemies, Enemy_8.new(14500, false, 3))

    table.insert(enemies, Enemy_8.new(14900, false, 3))
    table.insert(enemies, Enemy_8.new(15000, false, 3))
    table.insert(enemies, Enemy_8.new(15100, false, 3))
    table.insert(enemies, Enemy_8.new(15200, false, 3))

    table.insert(enemies, Enemy_8.new(15400, false, 3))
    table.insert(enemies, Enemy_8.new(15500, false, 3))
    table.insert(enemies, Enemy_8.new(15600, false, 3))
    table.insert(enemies, Enemy_8.new(15700, false, 3))
    table.insert(enemies, Enemy_8.new(15800, false, 3))
    table.insert(enemies, Enemy_8.new(15900, false, 3))
    table.insert(enemies, Enemy_8.new(16000, true, 3))
    table.insert(enemies, Enemy_8.new(16100, false, 3))
    table.insert(enemies, Enemy_8.new(16300, true, 3))
    table.insert(enemies, Enemy_8.new(16400, false, 3))

    table.insert(enemies, Enemy_8.new(17000, false, 3))
    table.insert(enemies, Enemy_8.new(17200, false, 3))
    table.insert(enemies, Enemy_8.new(17400, false, 3))
    table.insert(enemies, Enemy_8.new(17600, false, 3))

    table.insert(enemies, Enemy_8.new(18000, false, 3))
    table.insert(enemies, Enemy_8.new(18200, false, 3))
    table.insert(enemies, Enemy_8.new(18400, false, 3))
    table.insert(enemies, Enemy_8.new(18600, false, 3))
    table.insert(enemies, Enemy_8.new(18800, true, 3))
    table.insert(enemies, Enemy_8.new(19000, true, 3))
    table.insert(enemies, Enemy_8.new(19200, false, 3))
    table.insert(enemies, Enemy_8.new(19400, false, 3))
    table.insert(enemies, Enemy_8.new(19600, false, 3))
    table.insert(enemies, Enemy_8.new(19800, false, 3))

    table.insert(enemies, Enemy_8.new(20200, false, 3))
    table.insert(enemies, Enemy_8.new(20400, false, 3))
    table.insert(enemies, Enemy_8.new(20600, false, 3))
    table.insert(enemies, Enemy_8.new(20800, false, 3))

    table.insert(enemies, Enemy_8.new(21200, false, 3))
    table.insert(enemies, Enemy_8.new(21400, false, 3))
    table.insert(enemies, Enemy_8.new(21600, false, 3))
    table.insert(enemies, Enemy_8.new(21800, false, 3))

    table.insert(enemies, Enemy_8.new(22200, false, 3))
    table.insert(enemies, Enemy_8.new(22400, false, 3))
    table.insert(enemies, Enemy_8.new(22600, false, 3))
    table.insert(enemies, Enemy_8.new(22800, false, 3))
    table.insert(enemies, Enemy_8.new(23000, true, 3))
    table.insert(enemies, Enemy_8.new(23200, false, 3))
    table.insert(enemies, Enemy_8.new(23400, false, 3))
    table.insert(enemies, Enemy_8.new(23600, false, 3))
    table.insert(enemies, Enemy_8.new(23800, false, 3))
...
function update_level_9(dt)
    ...
    if gamestatus == true then
        ...
        -- Music
        if current_screen == "level_9" then
            sounds.music:play()
        ...
        if x >= -1195 then
            ...
            if player.x > love.graphics.getWidth() then
                ...
                win_sound = true
                sounds.music:stop()
                Win9.update_win(dt, "level_10", reset_level_9)
            end
        end
        ...
        local press = keypressed_9(key_pressed)
        ...
        -- Gameover update
        update_go(dt, "level_9", reset_level_9)
    end
end

-- Function that helps handeling if the key is held down    
function keyreleased_9(key)
    if key == keys[1] then
        key_released = true
    end
end
...
return {
    load_level_9 = load_level_9,
    draw_level_9 = draw_level_9,
    keypressed_9 = keypressed_9,
    keyreleased_9 = keyreleased_9, 
    update_level_9 = update_level_9,
    reset_level_9 = reset_level_9
}