...
local Win17 = require "Screens/Win"
local completed
local win_sound
...
function load_level_17()
    ...
    enemies = {}
    keys = {'v', 'z', 'space', 'n', 'b', 'space', 'space', 'z', 'c', 'b', 'z', 'z', 'space', ',', 'n', 'z', 'space', ',', 'space', 'z', 'space', 'z', 'space', 'm', 'space', 'm', 'm', 'c', 'space', 'x', 'c', 'n', 'space', 'm', 'space', 'n', 'x', 'space', 'z', 'n', 'space', 'space', ',', 'z', 'z', 'b', 'c', 'z', 'space', 'm', 'm', 'space', ',', 'b', 'c', 'x', 'c', 'n', 'x', 'b', 'v', 'n', 'm', 'b', 'space', 'x', 'space', 'x', 'v', 'z', 'x', 'm', 'c', 'b', 'v', ',', 'space', 'space', 'x', 'c', 'b', 'n', 'c', 'b', ',', 'c', 'b', 'c', 'x', 'm', 'n', 'c', 'z', 'm', 'space', 'z', 'x', 'c', 'm'}
...
function draw_level_17()
    -- Draws the map
    mlevel_17:draw(x,-20,2)
...
function update_level_17(dt)
    ...
    if gamestatus == true then
        ...
        -- Music
        if current_screen == "level_17" then
            sounds.music:play()
        ...
        if x >= -1195 then
            ...
            if player.x > love.graphics.getWidth() then
                ...
                win_sound = true
                sounds.music:stop()
                Win17.update_win(dt, "level_18", reset_level_17)
            end
        end
        ...
        local press = keypressed_17(key_pressed)
        ...
        -- Gameover update
        update_go(dt, "level_17", reset_level_17)    
    end
end

-- Function that helps handeling if the key is held down    
function keyreleased_17(key)
    if key == keys[1] then
        key_released = true
    end
end
...
return {
    load_level_17 = load_level_17,
    draw_level_17 = draw_level_17,
    keypressed_17 = keypressed_17,
    keyreleased_17 = keyreleased_17, 
    update_level_17 = update_level_17,
    reset_level_17 = reset_level_17
}