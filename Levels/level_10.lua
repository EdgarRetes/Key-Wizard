...
-- Table to store enemies in level 10
local enemies
...
local Win10 = require "Screens/Win"
local completed
local win_sound
...
function load_level_10()
    ...
    enemies = {}
    keys = {"q", "p", "space", "q", "p", "space", "space", "p", "q", "q", "q", "q", "space", "p", "p", "p", "space", "q", "space", "q", "space", "p", "space", "p", "space", "p", "p", "q", "space", "p", "q", "p", "space", "q", "space", "p", "q", "space", "p", "p", "space", "space", "q", "p", "q", "q", "p", "q", "space", "p", "p", "space", "q", "q", "p", "q", "p", "p", "p", "q", "q", "p", "p", "p", "space", "q", "space", "p", "q", "w", "e", "r", "u", "i", "o", "p", "space", "space", "p", "q", "w", "o", "r", "u", "e", "i", "i", "e", "r", "u", "q", "p", "w", "o", "space", "q", "p", "p", "q"}
    ...
    -- Create Enemy_9 instances and add them to the 'enemies' table

    table.insert(enemies, Enemy_9.new(1500, false, 2))
    table.insert(enemies, Enemy_9.new(1700, false, 2))
    table.insert(enemies, Enemy_9.new(1900, true, 2))

    table.insert(enemies, Enemy_9.new(2300, false, 2))
    table.insert(enemies, Enemy_9.new(2500, false, 2))
    table.insert(enemies, Enemy_9.new(2700, true, 2))

    table.insert(enemies, Enemy_9.new(3100, true, 2))
    table.insert(enemies, Enemy_9.new(3300, false, 2))
    table.insert(enemies, Enemy_9.new(3500, false, 2))

    table.insert(enemies, Enemy_9.new(3900, false, 2))
    table.insert(enemies, Enemy_9.new(4100, false, 2))
    ...
    table.insert(enemies, Enemy_9.new(5000, false, 2))
    table.insert(enemies, Enemy_9.new(5100, false, 2))
    table.insert(enemies, Enemy_9.new(5200, true, 2))

    table.insert(enemies, Enemy_9.new(5500, false, 2))
    table.insert(enemies, Enemy_9.new(5600, true, 2))
    table.insert(enemies, Enemy_9.new(5700, false, 2))
    table.insert(enemies, Enemy_9.new(5800, true, 2))

    table.insert(enemies, Enemy_9.new(6100, false, 2))
    table.insert(enemies, Enemy_9.new(6200, true, 2))
    table.insert(enemies, Enemy_9.new(6300, false, 2))
    table.insert(enemies, Enemy_9.new(6400, true, 2))

    table.insert(enemies, Enemy_9.new(10500, false, 3))
    table.insert(enemies, Enemy_9.new(10600, false, 3))
    table.insert(enemies, Enemy_9.new(10700, false, 3))
    table.insert(enemies, Enemy_9.new(10800, true, 3))
    table.insert(enemies, Enemy_9.new(10900, false, 3))
    table.insert(enemies, Enemy_9.new(11000, false, 3))
    table.insert(enemies, Enemy_9.new(11100, false, 3))
    table.insert(enemies, Enemy_9.new(11200, true, 3))

    table.insert(enemies, Enemy_9.new(11600, false, 3))
    table.insert(enemies, Enemy_9.new(11700, true, 3))
    table.insert(enemies, Enemy_9.new(11800, false, 3))
    table.insert(enemies, Enemy_9.new(11900, false, 3))
    table.insert(enemies, Enemy_9.new(12000, true, 3))
    table.insert(enemies, Enemy_9.new(12100, false, 3))
    table.insert(enemies, Enemy_9.new(12200, false, 3))

    table.insert(enemies, Enemy_9.new(12600, true, 3))
    table.insert(enemies, Enemy_9.new(12700, true, 3))
    table.insert(enemies, Enemy_9.new(12800, false, 3))
    table.insert(enemies, Enemy_9.new(12900, false, 3))
    table.insert(enemies, Enemy_9.new(13000, false, 3))
    table.insert(enemies, Enemy_9.new(13100, false, 3))
    table.insert(enemies, Enemy_9.new(13200, false, 3))
    table.insert(enemies, Enemy_9.new(13300, false, 3))
    table.insert(enemies, Enemy_9.new(13400, true, 3))

    table.insert(enemies, Enemy_9.new(13900, false, 3))
    table.insert(enemies, Enemy_9.new(14000, false, 3))
    table.insert(enemies, Enemy_9.new(14200, true, 3))
    table.insert(enemies, Enemy_9.new(14400, false, 3))
    table.insert(enemies, Enemy_9.new(14500, false, 3))

    table.insert(enemies, Enemy_9.new(14900, false, 3))
    table.insert(enemies, Enemy_9.new(15000, false, 3))
    table.insert(enemies, Enemy_9.new(15100, false, 3))
    table.insert(enemies, Enemy_9.new(15200, false, 3))

    table.insert(enemies, Enemy_9.new(15400, false, 3))
    table.insert(enemies, Enemy_9.new(15500, false, 3))
    table.insert(enemies, Enemy_9.new(15600, false, 3))
    table.insert(enemies, Enemy_9.new(15700, false, 3))
    table.insert(enemies, Enemy_9.new(15800, false, 3))
    table.insert(enemies, Enemy_9.new(15900, false, 3))
    table.insert(enemies, Enemy_9.new(16000, true, 3))
    table.insert(enemies, Enemy_9.new(16100, false, 3))
    table.insert(enemies, Enemy_9.new(16300, true, 3))
    table.insert(enemies, Enemy_9.new(16400, false, 3))

    table.insert(enemies, Enemy_9.new(17000, false, 3))
    table.insert(enemies, Enemy_9.new(17200, false, 3))
    table.insert(enemies, Enemy_9.new(17400, false, 3))
    table.insert(enemies, Enemy_9.new(17600, false, 3))

    table.insert(enemies, Enemy_9.new(18000, false, 3))
    table.insert(enemies, Enemy_9.new(18200, false, 3))
    table.insert(enemies, Enemy_9.new(18400, false, 3))
    table.insert(enemies, Enemy_9.new(18600, false, 3))
    table.insert(enemies, Enemy_9.new(18800, true, 3))
    table.insert(enemies, Enemy_9.new(19000, true, 3))
    table.insert(enemies, Enemy_9.new(19200, false, 3))
    table.insert(enemies, Enemy_9.new(19400, false, 3))
    table.insert(enemies, Enemy_9.new(19600, false, 3))
    table.insert(enemies, Enemy_9.new(19800, false, 3))

    table.insert(enemies, Enemy_9.new(20200, false, 3))
    table.insert(enemies, Enemy_9.new(20400, false, 3))
    table.insert(enemies, Enemy_9.new(20600, false, 3))
    table.insert(enemies, Enemy_9.new(20800, false, 3))

    table.insert(enemies, Enemy_9.new(21200, false, 3))
    table.insert(enemies, Enemy_9.new(21400, false, 3))
    table.insert(enemies, Enemy_9.new(21600, false, 3))
    table.insert(enemies, Enemy_9.new(21800, false, 3))

    table.insert(enemies, Enemy_9.new(22200, false, 3))
    table.insert(enemies, Enemy_9.new(22400, false, 3))
    table.insert(enemies, Enemy_9.new(22600, false, 3))
    table.insert(enemies, Enemy_9.new(22800, false, 3))
    table.insert(enemies, Enemy_9.new(23000, true, 3))
    table.insert(enemies, Enemy_9.new(23200, false, 3))
    table.insert(enemies, Enemy_9.new(23400, false, 3))
    table.insert(enemies, Enemy_9.new(23600, false, 3))
...
function draw_level_10()
    -- Draws the map
    mlevel_10:draw(x,-20,2)
...
function update_level_10(dt)
    ...
    if gamestatus == true then
        ...
        -- Music
        if current_screen == "level_10" then
            sounds.music:play()
        ...
        if x >= -1195 then
            ...
            if player.x > love.graphics.getWidth() then
                ...
                win_sound = true
                sounds.music:stop()
                Win10.update_win(dt, "level_11", reset_level_10)
            end
        end
        ...
        local press = keypressed_10(key_pressed)
        ...
        -- Gameover update
        update_go(dt, "level_10", reset_level_10)
    end
end

-- Function that helps handeling if the key is held down    
function keyreleased_10(key)
    if key == keys[1] then
        key_released = true
    end
end
...
return {
    load_level_10 = load_level_10,
    draw_level_10 = draw_level_10,
    keypressed_10 = keypressed_10,
    keyreleased_10 = keyreleased_10, 
    update_level_10 = update_level_10,
    reset_level_10 = reset_level_10
}