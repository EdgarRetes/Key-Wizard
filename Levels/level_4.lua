...
-- Table to store enemies in level 4
local enemies
...
local Win4 = require "Screens/Win"
local completed
local win_sound
...
function load_level_4()
    ...
    enemies = {}
    keys = {"a", ".", "space", "a", ".", "space", "space", ".", "a", "a", "a", "a", "space", ".", ".", ".", "space", "a", "space", "a", "space", ".", "space", ".", "space", ".", ".", "a", "space", ".", "a", ".", "space", "a", "space", ".", "a", "space", ".", ".", "space", "space", "a", ".", "a", "a", ".", "a", "space", ".", ".", "space", "a", "a", ".", "a", ".", ".", ".", "a", "a", ".", ".", ".", "space", "a", "space", ".", "a", "s", "d", "f", "j", "k", "l", ".", "space", "space", ".", "a", "s", "l", "f", "j", "d", "k", "k", "d", "f", "j", "a", ".", "s", "l", "space", "a", ".", ".", "a"}
    ...
    table.insert(enemies, Enemy_4.new(1500, false, 2))
    table.insert(enemies, Enemy_4.new(1700, false, 2))
    table.insert(enemies, Enemy_4.new(1900, true, 2))

    table.insert(enemies, Enemy_4.new(2300, false, 2))
    table.insert(enemies, Enemy_4.new(2500, false, 2))
    table.insert(enemies, Enemy_4.new(2700, true, 2))

    table.insert(enemies, Enemy_4.new(3100, true, 2))
    table.insert(enemies, Enemy_4.new(3300, false, 2))
    table.insert(enemies, Enemy_4.new(3500, false, 2))

    table.insert(enemies, Enemy_4.new(3900, false, 2))
    table.insert(enemies, Enemy_4.new(4100, false, 2))
    table.insert(enemies, Enemy_4.new(4300, false, 2))
    table.insert(enemies, Enemy_4.new(4500, true, 2))

    table.insert(enemies, Enemy_4.new(4900, false, 2))
    table.insert(enemies, Enemy_4.new(5000, false, 2))
    table.insert(enemies, Enemy_4.new(5100, false, 2))
    table.insert(enemies, Enemy_4.new(5200, true, 2))

    table.insert(enemies, Enemy_4.new(5500, false, 2))
    table.insert(enemies, Enemy_4.new(5600, true, 2))
    table.insert(enemies, Enemy_4.new(5700, false, 2))
    table.insert(enemies, Enemy_4.new(5800, true, 2))

    table.insert(enemies, Enemy_4.new(6100, false, 2))
    table.insert(enemies, Enemy_4.new(6200, true, 2))
    table.insert(enemies, Enemy_4.new(6300, false, 2))
    table.insert(enemies, Enemy_4.new(6400, true, 2))

    table.insert(enemies, Enemy_4.new(10500, false, 3))
    table.insert(enemies, Enemy_4.new(10600, false, 3))
    table.insert(enemies, Enemy_4.new(10700, false, 3))
    table.insert(enemies, Enemy_4.new(10800, true, 3))
    table.insert(enemies, Enemy_4.new(10900, false, 3))
    table.insert(enemies, Enemy_4.new(11000, false, 3))
    table.insert(enemies, Enemy_4.new(11100, false, 3))
    table.insert(enemies, Enemy_4.new(11200, true, 3))

    table.insert(enemies, Enemy_4.new(11600, false, 3))
    table.insert(enemies, Enemy_4.new(11700, true, 3))
    table.insert(enemies, Enemy_4.new(11800, false, 3))
    table.insert(enemies, Enemy_4.new(11900, false, 3))
    table.insert(enemies, Enemy_4.new(12000, true, 3))
    table.insert(enemies, Enemy_4.new(12100, false, 3))
    table.insert(enemies, Enemy_4.new(12200, false, 3))

    table.insert(enemies, Enemy_4.new(12600, true, 3))
    table.insert(enemies, Enemy_4.new(12700, true, 3))
    table.insert(enemies, Enemy_4.new(12800, false, 3))
    table.insert(enemies, Enemy_4.new(12900, false, 3))
    table.insert(enemies, Enemy_4.new(13000, false, 3))
    table.insert(enemies, Enemy_4.new(13100, false, 3))
    table.insert(enemies, Enemy_4.new(13200, false, 3))
    table.insert(enemies, Enemy_4.new(13300, false, 3))
    table.insert(enemies, Enemy_4.new(13400, true, 3))

    table.insert(enemies, Enemy_4.new(13900, false, 3))
    table.insert(enemies, Enemy_4.new(14000, false, 3))
    table.insert(enemies, Enemy_4.new(14200, true, 3))
    table.insert(enemies, Enemy_4.new(14400, false, 3))
    table.insert(enemies, Enemy_4.new(14500, false, 3))

    table.insert(enemies, Enemy_4.new(14900, false, 3))
    table.insert(enemies, Enemy_4.new(15000, false, 3))
    table.insert(enemies, Enemy_4.new(15100, false, 3))
    table.insert(enemies, Enemy_4.new(15200, false, 3))

    table.insert(enemies, Enemy_4.new(15400, false, 3))
    table.insert(enemies, Enemy_4.new(15500, false, 3))
    table.insert(enemies, Enemy_4.new(15600, false, 3))
    table.insert(enemies, Enemy_4.new(15700, false, 3))
    table.insert(enemies, Enemy_4.new(15800, false, 3))
    table.insert(enemies, Enemy_4.new(15900, false, 3))
    table.insert(enemies, Enemy_4.new(16000, true, 3))
    table.insert(enemies, Enemy_4.new(16100, false, 3))
    table.insert(enemies, Enemy_4.new(16300, true, 3))
    table.insert(enemies, Enemy_4.new(16400, false, 3))

    table.insert(enemies, Enemy_4.new(17000, false, 3))
    table.insert(enemies, Enemy_4.new(17200, false, 3))
    table.insert(enemies, Enemy_4.new(17400, false, 3))
    table.insert(enemies, Enemy_4.new(17600, false, 3))

    table.insert(enemies, Enemy_4.new(18000, false, 3))
    table.insert(enemies, Enemy_4.new(18200, false, 3))
    table.insert(enemies, Enemy_4.new(18400, false, 3))
    table.insert(enemies, Enemy_4.new(18600, false, 3))
    table.insert(enemies, Enemy_4.new(18800, true, 3))
    table.insert(enemies, Enemy_4.new(19000, true, 3))
    table.insert(enemies, Enemy_4.new(19200, false, 3))
    table.insert(enemies, Enemy_4.new(19400, false, 3))
    table.insert(enemies, Enemy_4.new(19600, false, 3))
    table.insert(enemies, Enemy_4.new(19800, false, 3))

    table.insert(enemies, Enemy_4.new(20200, false, 3))
    table.insert(enemies, Enemy_4.new(20400, false, 3))
    table.insert(enemies, Enemy_4.new(20600, false, 3))
    table.insert(enemies, Enemy_4.new(20800, false, 3))

    table.insert(enemies, Enemy_4.new(21200, false, 3))
    table.insert(enemies, Enemy_4.new(21400, false, 3))
    table.insert(enemies, Enemy_4.new(21600, false, 3))
    table.insert(enemies, Enemy_4.new(21800, false, 3))

    table.insert(enemies, Enemy_4.new(22200, false, 3))
    table.insert(enemies, Enemy_4.new(22400, false, 3))
    table.insert(enemies, Enemy_4.new(22600, false, 3))
    table.insert(enemies, Enemy_4.new(22800, false, 3))
    table.insert(enemies, Enemy_4.new(23000, true, 3))
    table.insert(enemies, Enemy_4.new(23200, false, 3))
    table.insert(enemies, Enemy_4.new(23400, false, 3))
    table.insert(enemies, Enemy_4.new(23600, false, 3))
    table.insert(enemies, Enemy_4.new(23800, false, 3))
...
function update_level_4(dt)
    ...
    if gamestatus == true then
        ...
        -- Music
        if current_screen == "level_4" then
            sounds.music:play()
        ...
        if x >= -1195 then
            ...
            if player.x > love.graphics.getWidth() then
                ...
                win_sound = true
                sounds.music:stop()
                Win3.update_win(dt, "level_5", reset_level_4)
            end
        end
        ...
        local press = keypressed_4(key_pressed)
        ...
        -- Gameover update
        update_go(dt, "level_4", reset_level_4)
    end
end

-- Function that helps handeling if the key is held down    
function keyreleased_4(key)
    if key == keys[1] then
        key_released = true
    end
end
...
return {
    load_level_4 = load_level_4,
    draw_level_4 = draw_level_4,
    keypressed_4 = keypressed_4,
    keyreleased_4 = keyreleased_4, 
    update_level_4 = update_level_4,
    reset_level_4 = reset_level_4
}