...
local Win6 = require "Screens/Win"
local completed
local win_sound
...
function load_level_6()
    ...
    enemies = {}
    keys = {'f', 'g', 'space', 'k', 'j', 'space', 'space', 'a', 'd', 'j', 'g', 'a', 'space', '.', 'k', 'h', 'space', '.', 'space', 'h', 'space', 'g', 'space', 'l', 'space', 'l', 'l', 'd', 'space', 's', 'd', 'k', 'space', '.', 'space', 'k', 'a', 'space', 'g', 'k', 'space', 'space', '.', 'a', 'g', 'j', 'd', 'h', 'space', 'l', 'l', 'space', '.', 'j', 'd', 's', 'd', 'k', 'a', 'j', 'f', 'k', '.', 'j', 'space', 'a', 'space', 's', 'f', 'h', 'a', '.', 'd', 'j', 'f', '.', 'space', 'space', 'a', 'd', 'j', 'k', 'd', 'j', '.', 'd', 'j', 'd', 's', 'l', 'k', 'd', 'g', 'l', 'space', 'g', 'h', 'd', '.'}
    ...
    table.insert(enemies, Enemy_1.new(1500, false, 2))
    table.insert(enemies, Enemy_5.new(1700, false, 2))
    table.insert(enemies, Enemy_5.new(1900, true, 2))

    table.insert(enemies, Enemy_2.new(2300, false, 2))
    table.insert(enemies, Enemy_1.new(2500, false, 2))
    table.insert(enemies, Enemy_1.new(2700, true, 2))

    table.insert(enemies, Enemy_5.new(3100, true, 2))
    table.insert(enemies, Enemy_4.new(3300, false, 2))
    table.insert(enemies, Enemy_2.new(3500, false, 2))

    table.insert(enemies, Enemy_1.new(3900, false, 2))
    ...
    table.insert(enemies, Enemy_2.new(5000, false, 2))
    ...
    table.insert(enemies, Enemy_2.new(10700, false, 3))
    table.insert(enemies, Enemy_2.new(10800, true, 3))
    table.insert(enemies, Enemy_3.new(10900, false, 3))
    table.insert(enemies, Enemy_2.new(11000, false, 3))
    table.insert(enemies, Enemy_2.new(11100, false, 3))
    table.insert(enemies, Enemy_2.new(11200, true, 3))

    table.insert(enemies, Enemy_4.new(11600, false, 3))
    table.insert(enemies, Enemy_4.new(11700, true, 3))
    table.insert(enemies, Enemy_2.new(11800, false, 3))
    ...
    table.insert(enemies, Enemy_2.new(12200, false, 3))

    table.insert(enemies, Enemy_1.new(12600, true, 3))
    table.insert(enemies, Enemy_2.new(12700, true, 3))
    ...
    table.insert(enemies, Enemy_1.new(13100, false, 3))
    table.insert(enemies, Enemy_2.new(13200, false, 3))
    ...
    table.insert(enemies, Enemy_1.new(14500, false, 3))

    table.insert(enemies, Enemy_2.new(14900, false, 3))
    table.insert(enemies, Enemy_3.new(15000, false, 3))
    table.insert(enemies, Enemy_2.new(15100, false, 3))
    table.insert(enemies, Enemy_2.new(15200, false, 3))

    table.insert(enemies, Enemy_4.new(15400, false, 3))
    table.insert(enemies, Enemy_1.new(15500, false, 3))
    table.insert(enemies, Enemy_1.new(15600, false, 3))
    table.insert(enemies, Enemy_2.new(15700, false, 3))
    table.insert(enemies, Enemy_4.new(15800, false, 3))
    table.insert(enemies, Enemy_1.new(15900, false, 3))
    table.insert(enemies, Enemy_1.new(16000, true, 3))
    ...
    table.insert(enemies, Enemy_1.new(17000, false, 3))
    ...
    table.insert(enemies, Enemy_2.new(18000, false, 3))
    table.insert(enemies, Enemy_1.new(18200, false, 3))
    table.insert(enemies, Enemy_1.new(18400, false, 3))
    table.insert(enemies, Enemy_4.new(18600, false, 3))
    table.insert(enemies, Enemy_2.new(18800, true, 3))
    table.insert(enemies, Enemy_2.new(19000, true, 3))
    table.insert(enemies, Enemy_4.new(19200, false, 3))
    table.insert(enemies, Enemy_2.new(19400, false, 3))
    table.insert(enemies, Enemy_1.new(19600, false, 3))
    table.insert(enemies, Enemy_2.new(19800, false, 3))

    table.insert(enemies, Enemy_2.new(20200, false, 3))
    table.insert(enemies, Enemy_1.new(20400, false, 3))
    table.insert(enemies, Enemy_4.new(20600, false, 3))
    table.insert(enemies, Enemy_2.new(20800, false, 3))

    table.insert(enemies, Enemy_1.new(21200, false, 3))
    table.insert(enemies, Enemy_2.new(21400, false, 3))
    table.insert(enemies, Enemy_3.new(21600, false, 3))
    table.insert(enemies, Enemy_3.new(21800, false, 3))

    table.insert(enemies, Enemy_2.new(22200, false, 3))
    table.insert(enemies, Enemy_2.new(22400, false, 3))
    ...
    table.insert(enemies, Enemy_2.new(23600, false, 3))
...
function update_level_6(dt)
    ...
    if gamestatus == true then
        ...
        -- Music
        if current_screen == "level_6" then
            sounds.music:play()
        ...
        if x >= -1195 then
            ...
            if player.x > love.graphics.getWidth() then
                ...
                win_sound = true
                sounds.music:stop()
                Win6.update_win(dt, "level_7", reset_level_6)
            end
        end
        ...
        local press = keypressed_6(key_pressed)
        ...
        -- Gameover update
        update_go(dt, "level_6", reset_level_6)    
    end
end

-- Function that helps handeling if the key is held down    
function keyreleased_6(key)
    if key == keys[1] then
        key_released = true
    end
end
...
return {
    load_level_6 = load_level_6,
    draw_level_6 = draw_level_6,
    keypressed_6 = keypressed_6,
    keyreleased_6 = keyreleased_6, 
    update_level_6 = update_level_6,
    reset_level_6 = reset_level_6
}