...
-- Table to store enemies in level 6
local enemies
...
local Win12 = require "Screens/Win"
local completed
local win_sound
...
function load_level_12()
    ...
    enemies = {}
    keys = {'r', 't', 'space', 'i', 'u', 'space', 'space', 'q', 'e', 'u', 't', 'q', 'space', 'p', 'i', 'y', 'space', 'p', 'space', 'y', 'space', 't', 'space', 'o', 'space', 'o', 'o', 'e', 'space', 'w', 'e', 'i', 'space', 'p', 'space', 'i', 'q', 'space', 't', 'i', 'space', 'space', 'p', 'q', 't', 'u', 'e', 'y', 'space', 'o', 'o', 'space', 'p', 'u', 'e', 'w', 'e', 'i', 'q', 'u', 'r', 'i', 'p', 'u', 'space', 'q', 'space', 'w', 'r', 'y', 'q', 'p', 'e', 'u', 'r', 'p', 'space', 'space', 'q', 'e', 'u', 'i', 'e', 'u', 'p', 'e', 'u', 'e', 'w', 'o', 'i', 'e', 't', 'o', 'space', 't', 'y', 'e', 'p'}
    ...
    table.insert(enemies, Enemy_6.new(1500, false, 2))
    table.insert(enemies, Enemy_10.new(1700, false, 2))
    table.insert(enemies, Enemy_10.new(1900, true, 2))

    table.insert(enemies, Enemy_7.new(2300, false, 2))
    table.insert(enemies, Enemy_6.new(2500, false, 2))
    table.insert(enemies, Enemy_6.new(2700, true, 2))
    
    table.insert(enemies, Enemy_10.new(3100, true, 2))
    table.insert(enemies, Enemy_9.new(3300, false, 2))
    table.insert(enemies, Enemy_7.new(3500, false, 2))
    
    table.insert(enemies, Enemy_6.new(3900, false, 2))
    table.insert(enemies, Enemy_10.new(4100, false, 2))
    table.insert(enemies, Enemy_9.new(4300, false, 2))
    table.insert(enemies, Enemy_9.new(4500, true, 2))
    
    table.insert(enemies, Enemy_9.new(4900, false, 2))
    table.insert(enemies, Enemy_7.new(5000, false, 2))
    table.insert(enemies, Enemy_10.new(5100, false, 2))
    table.insert(enemies, Enemy_10.new(5200, true, 2))
    
    table.insert(enemies, Enemy_9.new(5500, false, 2))
    table.insert(enemies, Enemy_9.new(5600, true, 2))
    ...
    table.insert(enemies, Enemy_8.new(6300, false, 2))
    table.insert(enemies, Enemy_8.new(6400, true, 2))
    
    table.insert(enemies, Enemy_8.new(10500, false, 3))
    table.insert(enemies, Enemy_8.new(10600, false, 3))
    table.insert(enemies, Enemy_7.new(10700, false, 3))
    table.insert(enemies, Enemy_7.new(10800, true, 3))
    table.insert(enemies, Enemy_8.new(10900, false, 3))
    table.insert(enemies, Enemy_7.new(11000, false, 3))
    table.insert(enemies, Enemy_7.new(11100, false, 3))
    table.insert(enemies, Enemy_7.new(11200, true, 3))
    
    table.insert(enemies, Enemy_9.new(11600, false, 3))
    table.insert(enemies, Enemy_9.new(11700, true, 3))
    table.insert(enemies, Enemy_7.new(11800, false, 3))
    table.insert(enemies, Enemy_9.new(11900, false, 3))
    table.insert(enemies, Enemy_9.new(12000, true, 3))
    table.insert(enemies, Enemy_10.new(12100, false, 3))
    table.insert(enemies, Enemy_7.new(12200, false, 3))
    
    table.insert(enemies, Enemy_6.new(12600, true, 3))
    table.insert(enemies, Enemy_7.new(12700, true, 3))
    table.insert(enemies, Enemy_9.new(12800, false, 3))
    table.insert(enemies, Enemy_9.new(12900, false, 3))
    table.insert(enemies, Enemy_10.new(13000, false, 3))
    table.insert(enemies, Enemy_6.new(13100, false, 3))
    table.insert(enemies, Enemy_7.new(13200, false, 3))
    table.insert(enemies, Enemy_10.new(13300, false, 3))
    table.insert(enemies, Enemy_10.new(13400, true, 3))
    
    table.insert(enemies, Enemy_8.new(13900, false, 3))
    table.insert(enemies, Enemy_8.new(14000, false, 3))
    table.insert(enemies, Enemy_8.new(14200, true, 3))
    table.insert(enemies, Enemy_9.new(14400, false, 3))
    table.insert(enemies, Enemy_6.new(14500, false, 3))
    
    table.insert(enemies, Enemy_7.new(14900, false, 3))
    table.insert(enemies, Enemy_8.new(15000, false, 3))
    table.insert(enemies, Enemy_7.new(15100, false, 3))
    table.insert(enemies, Enemy_7.new(15200, false, 3))
    
    table.insert(enemies, Enemy_9.new(15400, false, 3))
    table.insert(enemies, Enemy_6.new(15500, false, 3))
    table.insert(enemies, Enemy_6.new(15600, false, 3))
    table.insert(enemies, Enemy_7.new(15700, false, 3))
    table.insert(enemies, Enemy_9.new(15800, false, 3))
    table.insert(enemies, Enemy_6.new(15900, false, 3))
    table.insert(enemies, Enemy_6.new(16000, true, 3))
    table.insert(enemies, Enemy_9.new(16100, false, 3))
    table.insert(enemies, Enemy_9.new(16300, true, 3))
    table.insert(enemies, Enemy_8.new(16400, false, 3))
    
    table.insert(enemies, Enemy_6.new(17000, false, 3))
    table.insert(enemies, Enemy_10.new(17200, false, 3))
    table.insert(enemies, Enemy_9.new(17400, false, 3))
    table.insert(enemies, Enemy_9.new(17600, false, 3))
    
    table.insert(enemies, Enemy_7.new(18000, false, 3))
    table.insert(enemies, Enemy_6.new(18200, false, 3))
    table.insert(enemies, Enemy_6.new(18400, false, 3))
    table.insert(enemies, Enemy_9.new(18600, false, 3))
    table.insert(enemies, Enemy_7.new(18800, true, 3))
    table.insert(enemies, Enemy_7.new(19000, true, 3))
    table.insert(enemies, Enemy_9.new(19200, false, 3))
    table.insert(enemies, Enemy_7.new(19400, false, 3))
    table.insert(enemies, Enemy_6.new(19600, false, 3))
    table.insert(enemies, Enemy_7.new(19800, false, 3))
    
    table.insert(enemies, Enemy_7.new(20200, false, 3))
    table.insert(enemies, Enemy_6.new(20400, false, 3))
    table.insert(enemies, Enemy_9.new(20600, false, 3))
    table.insert(enemies, Enemy_7.new(20800, false, 3))
    
    table.insert(enemies, Enemy_6.new(21200, false, 3))
    table.insert(enemies, Enemy_7.new(21400, false, 3))
    table.insert(enemies, Enemy_8.new(21600, false, 3))
    table.insert(enemies, Enemy_8.new(21800, false, 3))
    
    table.insert(enemies, Enemy_7.new(22200, false, 3))
    table.insert(enemies, Enemy_7.new(22400, false, 3))
    table.insert(enemies, Enemy_10.new(22600, false, 3))
    table.insert(enemies, Enemy_8.new(22800, false, 3))
    ...
    table.insert(enemies, Enemy_7.new(23600, false, 3))
    table.insert(enemies, Enemy_9.new(23800, false, 3))
...
function draw_level_12()
    -- Draws the map
    mlevel_12:draw(x,-20,2)
...
function update_level_12(dt)
    ...
    if gamestatus == true then
        ...
        -- Music
        if current_screen == "level_12" then
            sounds.music:play()
        ...
        if x >= -1195 then
            ...
            if player.x > love.graphics.getWidth() then
                ...
                win_sound = true
                sounds.music:stop()
                Win2.update_win(dt, "level_13", reset_level_12)
            end
        end
        ...
        local press = keypressed_12(key_pressed)
        ...
        -- Gameover update
        update_go(dt, "level_12", reset_level_12)    
    end
end

-- Function that helps handeling if the key is held down    
function keyreleased_12(key)
    if key == keys[1] then
        key_released = true
    end
end
...
return {
    load_level_12 = load_level_12,
    draw_level_12 = draw_level_12,
    keypressed_12 = keypressed_12,
    keyreleased_12 = keyreleased_12, 
    update_level_12 = update_level_12,
    reset_level_12 = reset_level_12
}